...
Dim ticker_delta_range: Set ticker_delta_range = ThisWorkbook.Worksheets(s).Range("j2:j" & ThisWorkbook.Worksheets(s).Cells(Rows.Count, 10).End(xlUp).Row)
